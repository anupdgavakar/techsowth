...
<div class="bg-dash-dark-2 py-4">
    <div class="container-fluid">
        <h2 class="h5 mb-0">Edit Speaker</h2>
    </div>
</div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body pt-3">
                        <form method="post" action="{{route('update_speaker')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" type="text" class="form-control" value="{{$speaker->title}}" required>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    @foreach ($speaker_images as $item)
                                        <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control add_editor" rows="4" cols="50">{{$speaker->description}}</textarea>
                            </div>
