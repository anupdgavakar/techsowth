            ...
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-xl-6 col-lg-7 col-sm-8 position-relative text-center page-title-extra-small" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 400, "delay": 0, "staggervalue": 100, "easing": "easeOutQuad" }'>
                        ...
                        <h2 class="m-auto text-white alt-font text-shadow-double-large fw-700 w-90 xl-w-100" data-fancy-text='{ "opacity": [0, 1], "translateY": [50, 0], "filter": ["blur(20px)", "blur(0px)"], "string": ["Photo"], "duration": 400, "delay": 0, "speed": 50, "easing": "easeOutQuad" }'></h2>
                    </div> 
        ...
        <section class="ps-2 pe-2">
            <div class="container-fluid"> 
                <div class="row" >
                    ...
                    <div class="col-sm-6">
                        <div class="justified-gallery image-gallery-style-06" data-justified-options='{ "rowHeight": 500, "maxRowHeight": false, "captions": false, "margins": 20, "waitThumbnailsLoad": true }' data-anime='{ "el": "childs", "translateY": [100, 0],"opacity": [0,0], "duration": 500, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <!-- start gallery item -->
                            
                            @php $gallery = DB::table('gallery_images')->where('gallery_id',$data->id)->get(); @endphp
                            ...
                            <div class="gallery-box transition-inner-all text-center">
                                <a href="{{ asset('/upload/'.$val->image)}}" data-group="lightbox-group-gallery-item-2" title="{{$data->title}}">
                                    ...
                                    <div class="position-relative ">
                                        ...
                                        <span class="gallery-title text-black fs-15">{{$data->title}}</span>
